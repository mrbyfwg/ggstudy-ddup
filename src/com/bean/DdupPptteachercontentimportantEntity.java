...
@Entity
@Table(name = "ddup_pptteachercontentimportant", schema = "ddupmis", catalog = "")
@IdClass(DdupPptteachercontentimportantEntityPK.class)
public class DdupPptteachercontentimportantEntity {
    ...
    public boolean equals(Object o) {
        ...
        DdupPptteachercontentimportantEntity that = (DdupPptteachercontentimportantEntity) o;
